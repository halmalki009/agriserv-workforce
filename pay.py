...
# إعداد الخط المختار
# =========================
# الخط العربي المعتمد للوحة
font_choice = "Tajawal"
selected_font_family = '"Tajawal","Tahoma","Arial",sans-serif'
...
st.markdown(
    ...
    <style>
    :root {
        --dashboard-arabic-font: __FONT__;
    }
    ...
    div[role="dialog"] *,
    .js-plotly-plot .plotly * {
        font-family: var(--dashboard-arabic-font) !important;
    }

    /* لا نغير خط الأيقونات */
    .material-icons,
    .material-icons-outlined,
    .material-symbols-outlined,
    .material-symbols-rounded,
    ...
    """.replace("__FONT__", selected_font_family),
    unsafe_allow_html=True
)
...
def render_chart(fig):
    """عرض الرسم مع تطبيق خط Tajawal وتقليل عناصر Plotly غير الضرورية."""
    fig.update_layout(
        font=dict(
        ...
        legend=dict(
            font=dict(family="Tajawal, Tahoma, Arial, sans-serif", size=13)
        ),
        xaxis=dict(
            tickfont=dict(family="Tajawal, Tahoma, Arial, sans-serif", size=12),
            title_font=dict(family="Tajawal, Tahoma, Arial, sans-serif", size=13)
        ),
        yaxis=dict(
            tickfont=dict(family="Tajawal, Tahoma, Arial, sans-serif", size=12),
            title_font=dict(family="Tajawal, Tahoma, Arial, sans-serif", size=13)
...
if type_choice == "الكل":
    ...
    st.markdown(f"**عرض البيانات الحالي:** نوع الموظف — {type_choice} | {view_mode}")
...
# التبويبات
# =========================
executive_tab, workforce_tab, employee_details_tab, work_extra_tab, trips_tab, alerts_tab = st.tabs([
    "الملخص التنفيذي",
